...
void MJ::dresser::initialize(){
  ...
  if(m_templateType == 0){
    ...
    // m_corr_cen_b1 = {-.039,-.046,-.029,    0,-.029,-.034,    0, .061,   0, .062, .040,   0,  0,-.065,    0};
    // m_corr_for_b0 = {-.020,-.014,-.020,-.022,-.030,-.023,-.040,-.027,   0,-.022,-.018,   0,  0,    0,-.036};
    // m_corr_for_b1 = {    0,-.036,-.083,    0,-.070,    0,-.066,    0,   0, .041,    0,   0,  0, .094,-.075};
    // m_uncert_cen_b0 = .0007;
    // m_uncert_cen_b1 = .055;
    // m_uncert_for_b0 = .015;
    // m_uncert_for_b1 = .055;

    //ICHEP dataset
    // m_corr_cen_b0 = {-.024,-.020,-.031,-.016,-.018,-.020,    0,-.023, .016, .029,    0, .029, .047,    0, .040};
    // m_corr_cen_b1 = {    0,    0,-.065,    0,    0,    0,-.053,-.046,-.070,    0, .072, .149,    0,    0,-.089};
    // m_corr_for_b0 = {-.032,-.033,-.028,-.029,-.025,-.054,-.048,    0,-.015,    0,-.022, .045, .018, .028,    0};
    // m_corr_for_b1 = {    0,-.064,-.048,    0,    0,    0, .062,-.105,    0, .042,    0, .078,-.063,-.071, .091};
    // m_uncert_cen_b0 = 0.0146;
    // m_uncert_cen_b1 = 0.0223;
    // m_uncert_for_b0 = 0.0070;
    // m_uncert_for_b1 = 0.025;
